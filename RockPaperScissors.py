...
Label(root,text="Rock, Paper And Scissor", font="normal 20 bold", fg="blue").pack(pady=20)

frame1 = Frame(root)
frame1.pack()

l1 = Label(frame1, text="Player", font=10)
l2 = Label(frame1, text="VS", font="normal 20 bold")
...
b2 = Button(frame1, text="Paper", font=10, width=7, command=isrock)
b3 = Button(frame1, text="Scissor", font=10, width=7, command=isrock)
